...
*   [Makefile Function Syntax](#makefile-function-syntax)
    ...
    *   [User-defined Functions (Macros)](#user-defined-functions-macros)
        *   [Defining a Simple Macro](#defining-a-simple-macro)
    *   [Common String Functions](#common-string-functions)
        *   [`$(subst FROM,TO,TEXT)`](#subst-fromto-text)
        *   [`$(patsubst PATTERN,REPLACEMENT,TEXT)`](#patsubst-patternreplacementtext)
        *   [`$(strip STRING)`](#strip-string)
    *   [Common File Name Functions](#common-file-name-functions)
        *   [`$(dir NAMES...)`](#dir-names)
        *   [`$(notdir NAMES...)`](#notdir-names)
        *   [`$(suffix NAMES...)`](#suffix-names)
        *   [`$(basename NAMES...)`](#basename-names)
        *   [`$(addsuffix SUFFIX,NAMES...)`](#addsuffix-suffixnames)
        *   [`$(addprefix PREFIX,NAMES...)`](#addprefix-prefixnames)
    *   [Other Useful Functions](#other-useful-functions)
        *   [`$(foreach VAR,LIST,TEXT)`](#foreach-varlisttext)
        *   [`$(word N,TEXT)`](#word-ntext)
