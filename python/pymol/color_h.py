...
# From: https://pymolwiki.org/index.php/Color_h
...
def color_h(selection='all'):
        ...
        cmd.color("color_ile", f"({s} and resn ile)")
        cmd.color("color_phe", f"({s} and resn phe)")
        cmd.color("color_val", f"({s} and resn val)")
        cmd.color("color_leu", f"({s} and resn leu)")
        cmd.color("color_trp", f"({s} and resn trp)")
        cmd.color("color_met", f"({s} and resn met)")
        cmd.color("color_ala", f"({s} and resn ala)")
        cmd.color("color_gly", f"({s} and resn gly)")
        cmd.color("color_cys", f"({s} and resn cys)")
        cmd.color("color_tyr", f"({s} and resn tyr)")
        cmd.color("color_pro", f"({s} and resn pro)")
        cmd.color("color_thr", f"({s} and resn thr)")
        cmd.color("color_ser", f"({s} and resn ser)")
        cmd.color("color_his", f"({s} and resn his)")
        cmd.color("color_glu", f"({s} and resn glu)")
        cmd.color("color_asn", f"({s} and resn asn)")
        cmd.color("color_gln", f"({s} and resn gln)")
        cmd.color("color_asp", f"({s} and resn asp)")
        cmd.color("color_lys", f"({s} and resn lys)")
        cmd.color("color_arg", f"({s} and resn arg)")
